...
class TestCase(str_test.TestCaseWrapper):
    ...
    @str_test.error_message('Não funcionou para caso com zero.')
    def test_numbers_3_0(self):
        self.assertEqual(self.function(3,0), 3)

    def test_numbers_3_4(self):
        self.assertEqual(self.function(3,4), 4, 'Não funcionou para caso com dois números positivos.')
'''
...
class StrTestTest(unittest.TestCase):
    ...
    def test_doesnt_break_with_missing_function(self):
        f_name = 'wrong_name'
        result = str_test.run_tests(TARGET_CODE_1, TEST_CODE1, f_name)
        self.assertFalse(result.success)
        self.assertEqual(1, len(result.failure_msgs))
        self.assertEqual(
    ...
    def test_pass_all_tests(self):
        result = str_test.run_tests(TARGET_CODE_1, TEST_CODE1, 'ex1')
    ...
    def test_timeout(self):
        result = str_test.run_tests(TARGET_CODE_2, TEST_CODE1, 'ex1')
        self.assertEqual(2, result.result_obj.testsRun)
        self.assertFalse(result.success)
        self.assertEqual(2, len(result.failure_msgs))
        self.assertEqual(str_test.TIME_LIMIT_EXCEEDED,
                         result.failure_msgs[0])
        self.assertEqual(str_test.TIME_LIMIT_EXCEEDED,
    ...
    def test_one_failure(self):
        result = str_test.run_tests(TARGET_CODE_3, TEST_CODE1, 'ex1')
        self.assertEqual(2, result.result_obj.testsRun)
        self.assertFalse(result.success)
        self.assertEqual(1, len(result.failure_msgs))
    ...
    def test_division_by_zero(self):
        result = str_test.run_tests(TARGET_CODE_4, TEST_CODE1, 'ex1')
        self.assertEqual(2, result.result_obj.testsRun)
        self.assertFalse(result.success)
        self.assertEqual(2, len(result.failure_msgs))
        self.assertEqual('Não funcionou para caso com zero.',
                         result.failure_msgs[0])
        self.assertEqual(str_test.DEFAULT_MSG, result.failure_msgs[1])
        self.assertEqual(2, result.total_tests)

    def test_print(self):
        result = str_test.run_tests(TARGET_CODE_5, TEST_CODE2,
                                          'code_with_print')
    ...
    def test_print_failure(self):
        result = str_test.run_tests(TARGET_CODE_6, TEST_CODE2,
                                          'code_with_print')
        self.assertEqual(1, result.result_obj.testsRun)
        self.assertFalse(result.success)
        self.assertEqual(1, result.total_tests)
    ...
    def test_input(self):
        result = str_test.run_tests(TARGET_CODE_7, TEST_CODE3,
                                          'input_and_sum')
        self.assertEqual(2, result.result_obj.testsRun)
        self.assertTrue(result.success)
        self.assertEqual(2, result.total_tests)
    ...
    def test_fail_input(self):
        result = str_test.run_tests(TARGET_CODE_8, TEST_CODE3,
                                          'input_and_sum')
        self.assertEqual(2, result.result_obj.testsRun)
        self.assertFalse(result.success)
        self.assertEqual(2, result.total_tests)
    ...
    def test_run_program_if_no_function(self):
        result = str_test.run_tests(TARGET_CODE_9, TEST_CODE4, '')
        self.assertEqual(2, result.result_obj.testsRun)
        self.assertTrue(result.success)
        self.assertEqual(2, result.total_tests)

    def test_run_program_if_none_function(self):
        result = str_test.run_tests(TARGET_CODE_9, TEST_CODE4, None)
        self.assertEqual(2, result.result_obj.testsRun)
        self.assertTrue(result.success)
        self.assertEqual(2, result.total_tests)

    def test_run_program_with_error(self):
        result = str_test.run_tests(TARGET_CODE_10, TEST_CODE4, None)
        self.assertFalse(result.success)
        self.assertEqual(2, len(result.failure_msgs))
        for i in range(2):
    ...
    def test_open(self):
        result = str_test.run_tests(TARGET_CODE_11, TEST_CODE5, None)
        self.assertTrue(result.success)
        self.assertEqual(1, result.total_tests)

    def test_with_open(self):
        result = str_test.run_tests(TARGET_CODE_12, TEST_CODE5, None)
        self.assertTrue(result.success)
        self.assertEqual(1, result.total_tests)

    def test_open_file_that_doesnt_exist(self):
        result = str_test.run_tests(TARGET_CODE_13, TEST_CODE5, None)
        self.assertFalse(result.success)
        self.assertTrue('FileNotFoundError' in result.stack_traces[0])
        self.assertEqual(1, result.total_tests)

    def test_read_file_opened_for_writing(self):
        result = str_test.run_tests(TARGET_CODE_14, TEST_CODE5, None)
        self.assertFalse(result.success)
    ...
    def test_read_file_opened_for_appending(self):
        result = str_test.run_tests(TARGET_CODE_15, TEST_CODE5, None)
        self.assertFalse(result.success)
        self.assertTrue('UnsupportedOperation' in result.stack_traces[0])
        self.assertTrue('not readable' in result.stack_traces[0])
        self.assertEqual(1, result.total_tests)
    ...
    def test_write_file_opened_for_reading(self):
        result = str_test.run_tests(TARGET_CODE_16, TEST_CODE5, None)
        self.assertFalse(result.success)
        self.assertTrue('UnsupportedOperation' in result.stack_traces[0])
    ...
    def test_write(self):
        result = str_test.run_tests(TARGET_CODE_17, TEST_CODE6, None)
        self.assertTrue(result.success)
        self.assertEqual(1, result.total_tests)

    def test_append(self):
        result = str_test.run_tests(TARGET_CODE_18, TEST_CODE7, None)
        self.assertTrue(result.success)
        self.assertEqual(1, result.total_tests)

    def test_doesnt_allow_input_in_function_test(self):
        result = str_test.run_tests(TARGET_CODE_19, TEST_CODE8,
                                          'do_nothing')
        self.assertFalse(result.success)
    ...
    def test_use_random_randint(self):
        result = str_test.run_tests(TARGET_CODE_20, TEST_CODE9,
                                          'random_int')
        self.assertTrue(result.success)
        self.assertEqual(1, result.total_tests)

        result = str_test.run_tests(TARGET_CODE_21, TEST_CODE9,
                                          'random_int')
        self.assertTrue(result.success)
        self.assertEqual(1, result.total_tests)

        result = str_test.run_tests(TARGET_CODE_22, TEST_CODE9,
                                          'random_int')
        self.assertFalse(result.success)
        self.assertTrue(
    ...
    def test_doesnt_break_with_multiple_inputs(self):
        result = str_test.run_tests(TARGET_CODE_23, TEST_CODE10, None)
        self.assertTrue(result.success)
        self.assertEqual(2, result.total_tests)

    def test_get_stdout(self):
        result = str_test.run_tests(TARGET_CODE_24, TEST_CODE11, None)
        self.assertFalse(result.success)
...
class TestCaseWrapperTest(unittest.TestCase):
    def setUp(self):
        self.test_case_wrapper = str_test.TestCaseWrapper()
